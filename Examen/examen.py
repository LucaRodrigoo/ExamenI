...
def menu_principal():
     while True:
        ...
        print("5. Ingrese una palabra para repetirla: ")
        print("6. Division")
        print("7. Salir")
        ...
        if opcion == "1":
            ...
            print("Escriba a continuacion la palabra que desea repetir:")
            palabra= input()
            for i,in range (10):
                print (palabra)

        elif opcion == "6":
            dividendo= int (input(("Escriba el primer numero: ")))
            divisor= int (input(("Escriba el segundo numero: ")))
